...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link easyTicketsAbi}__ and `functionName` set to `"netId"`
 */
export const useReadEasyTicketsNetId = /*#__PURE__*/ createUseReadContract({
  abi: easyTicketsAbi,
  functionName: 'netId',
})
...
/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link easyTicketsAbi}__ and `functionName` set to `"updateToken"`
 */
export const useWriteEasyTicketsUpdateToken =
  /*#__PURE__*/ createUseWriteContract({
    abi: easyTicketsAbi,
...
/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link easyTicketsAbi}__ and `functionName` set to `"withdraw"`
 */
export const useWriteEasyTicketsWithdraw = /*#__PURE__*/ createUseWriteContract(
  { abi: easyTicketsAbi, functionName: 'withdraw' },
)
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link easyTicketsAbi}__ and `functionName` set to `"updateToken"`
 */
export const useSimulateEasyTicketsUpdateToken =
  /*#__PURE__*/ createUseSimulateContract({
    abi: easyTicketsAbi,
    functionName: 'updateToken',
  })
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link easyTicketsAbi}__ and `functionName` set to `"withdraw"`
 */
export const useSimulateEasyTicketsWithdraw =
  /*#__PURE__*/ createUseSimulateContract({
    abi: easyTicketsAbi,
